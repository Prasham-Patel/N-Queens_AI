...
class world:
    ...
    def __init__(self, file, reward_per_action, gamma, time_to_learn, prob_of_moving, policyNo, epsilon):
        self.file = file
...
if __name__ == '__main__':
    ...
    if len(sys.argv) != 8:
        ...
        grid_world = world(file, reward_per_action, gamma, time_to_learn, prob_of_moving, policy, 0.3)
        grid_world.get_grid()
        ...
        # grid_world2 = world(file, reward_per_action, gamma, time_to_learn, prob_of_moving, 1, 0.1)
        # grid_world2.get_grid()
        # grid_world2.SARSA()
        #
        #
        # grid_world3 = world(file, reward_per_action, gamma, time_to_learn, prob_of_moving, 1, 0.3)
        # grid_world3.get_grid()
        # grid_world3.SARSA()
        #
        #
        # grid_world4 = world(file, reward_per_action, gamma, time_to_learn, prob_of_moving, 3, 0.1)
        # grid_world4.get_grid()
        # grid_world4.SARSA()
        #
        #
        # plt.plot(grid_world.timeMatrix, grid_world.meanRewardMatrix, label = "e=0.01")
        #
        # plt.plot(grid_world2.timeMatrix, grid_world2.meanRewardMatrix, label = "e=0.1")
        #
        # plt.plot(grid_world3.timeMatrix, grid_world3.meanRewardMatrix, label = "e=0.3")
        #
        # plt.plot(grid_world4.timeMatrix, grid_world4.meanRewardMatrix, label = "Proposed")
        # plt.legend()
        # plt.xlabel('Time (s)')
        # plt.ylabel('Reward')
        # plt.title("Example 1")
