import numpy as np
import csv
import WPI_AI.Assignment_2.Utility as utility
import os
...
csv_ = CSV_("N_queens_sols/N8_sol.txt")
csv_.write_sols(res)
new_list = csv_.read_sols()
board = utility.boardGenerator(8)
...
# for i in range(1, 5):
#     file = "Data/N" + str(4 + i) + ".txt"
#     with open(file, 'w', newline='') as fp:
#         write = csv.writer(fp)
#         write.writerow([4+i])
#     fp.close()

csv_.creatCSV_board(board, cost, "Data/N8.txt")
board_list, cost_list = csv_.readCSV_board("Data/N8.txt")
print(cost_list)
